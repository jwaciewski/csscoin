...
uint256 hashGenesisBlock("0x572c39ec9c5a661e9fb035463fbf1c09a9407922c7113af00970af5b723d22b0");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Csscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Csscoin Signed Message:\n";
...
{
    // Csscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Csscoin: 100k blocks

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Csscoin: 2 days
static const int64 nTargetSpacing = 20 * 60; // Csscoin: 20 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Csscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe18085cfeb55ff92a88fe87e2b0d4a9e65c2880405480c6af051c984437df1fa");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        //     CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d0104404e592054696d65732030352f4f63742f32303131205374657665204a6f62732c204170706c65e280997320566973696f6e6172792c2044696573206184203536)
        ...
        block.nVersion = 1;
        block.nTime    = 1738443518;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085861748;

        if (fTestNet)
        {
            block.nTime    = 1738443502;
            block.nNonce   = 385650817;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
	...
	assert(block.hashMerkleRoot == uint256("0xd958b4c93b055e5a7ad9fce130c46770dc0318e7e6416c99a86f52d30b2bb5d4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf7, 0xcc, 0xb3, 0xd9 }; // Csscoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CsscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CsscoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CsscoinMiner(CWallet *pwallet)
{
    printf("CsscoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("csscoin-miner");
    ...
    try { loop {
        ...
        printf("Running CsscoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CsscoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CsscoinMiner, pwallet));
}
