...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Csscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"csscointools.com", "dnsseed.csscointools.com"},
    {"csscoinpool.org", "dnsseed.csscoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"csscointools.com", "testnet-seed.csscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Csscoin is probably already running."), addrBind.ToString().c_str());
        else
